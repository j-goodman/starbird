...
Jackhammer.prototype.act = function () {
  ...
  if (this.pos.x > game.canvasWidth + 20) {
    this.pos.x -= 4;
  }
...
Jackhammer.prototype.draw = Starsnake.prototype.draw;
...
Jackhammer.prototype.strike = function () {
  ...
  for (i=0 ; i<this.mineCount ; i++) {
    game.debris.push(new Mine (this.pos.x + 32, this.pos.y + 48, ((Math.random() * 16) - 8), (Math.random() * 11 + 1)));
  }
  this.cooldown = 120;
};
